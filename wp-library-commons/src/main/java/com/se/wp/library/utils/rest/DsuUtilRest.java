...
public class DsuUtilRest {
	...
	public void addSecurityHeaders(HttpServletResponse response)throws IOException  {
		...
		String csp=propertiesUtilRest.getProperty(dsuSecurityConfig, "dsu.header.contents.security.policy");
		String fp=propertiesUtilRest.getProperty(dsuSecurityConfig, "dsu.header.feature.security.policy");
		String rp=propertiesUtilRest.getProperty(dsuSecurityConfig, "dsu.header.referrer.security.policy");
		String acao=propertiesUtilRest.getProperty(dsuSecurityConfig, "dsu.header.access.control.allow.origin");
		String sts=propertiesUtilRest.getProperty(dsuSecurityConfig, "dsu.header.strict.transport.security");
		...
		String xContentTypeOptions=propertiesUtilRest.getProperty(dsuSecurityConfig, "dsu.header.x.content.type.options");
		String xFrameOptions=propertiesUtilRest.getProperty(dsuSecurityConfig, "dsu.header.x.frame.options");
		String xXssProtection=propertiesUtilRest.getProperty(dsuSecurityConfig, "dsu.header.x.xss.protection");
	...
	public Map<String, String> getSecurityHeaders() throws IOException {
		...
		String xContentTypeOptions = propertiesUtilRest.getProperty(dsuSecurityConfig,
	...
	public boolean isApiGeeConsumer() throws IOException {
		boolean isApiGeeConsumer = false;
			if (Boolean.parseBoolean(
				propertiesUtilRest.getProperty(Constants.GLOBAL_CONFIG_FILE_NAME, Constants.BSL_APIGEE_ENABLED))
				) {
